...
if has_lspconfig == false then return end
...
local lua_format = { command = 'lua-format', args = { '-i' } }
...
local server_configs = {
  diagnosticls = {
    ...
    init_options = {
      ...
      formatters = { black = black, isort = isort, lua_format = lua_format },
      formatFiletypes = { lua = { 'lua_format' }, python = { 'black', 'isort' } },
...
if has_local_lsp then server_configs = local_lsp.merge(server_configs) end
